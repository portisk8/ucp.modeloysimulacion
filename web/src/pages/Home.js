...
import { withRouter, setCustomText } from "react-router-dom";
      ...
      <div className = "body">
        <Row>
          <Col span={24} style={{marginTop: "15%" ,marginBottom: "17%", justifyContent: 'space-between'}}>
              ...
              <h2 style={{color:"white", fontSize: 30, fontFamily: ""}}>Alcanza tu peso ideal,comiendo tus platos favoritos.</h2>
